...
print(b.classify('I am so happy that the weather is getting warmer!'))
print(b.classify("The movie was really funny and I liked it a lot"))
print(b.classify("Best movie of all time"))

print(b.classify('The solar eclipse is going to be boring, why should we waste our time?'))
print(b.classify('I hate summer because it sucks'))
print(b.classify('That movie wa horrible and not funny at all'))
print(b.classify('Worst movie i ever watched'))
